...
namespace CommonGames.Utilities.Extensions
{
    ...
    public static partial class ContainerExtensions
    {
        ...
        */
        ...
        /// <summary> Get first value from list. </summary>
        [PublicAPI]
        public static T First<T>(this List<T> list) => list[0];

        /// <summary> Get last value from list. </summary>
        [PublicAPI]
        public static T Last<T>(this List<T> list) => list[list.Count - 1];

        /// <summary> Get middle value from list. </summary>
        [PublicAPI]
        public static T Middle<T>(this List<T> list) => list[Mathf.CeilToInt(list.Count / 2f) - 1];

        /// <summary> Get middle value from list. </summary>
        [PublicAPI]
        public static T Middle<T>(this T[] array) => array[Mathf.CeilToInt(array.Length / 2f) - 1];
        ...
        /// </summary>
        [PublicAPI]
        public static void SafeFor<T>(this T[] array, in Action<T> action)
        {
            int length = array.Length;
        ...
        [PublicAPI]
        public static void CGRemoveAll<T>(this List<T> list, in Func<T, bool> func)
        {
            int i = list.Count;
            while(i-- > 0)
            {
        ...
        /// </summary>
        [PublicAPI]
        public static bool Contains<T>(this List<T> list, in T value)
        {
            foreach (T item in list)
        ...
        /// </summary>
        [PublicAPI]
        public static int GetTopIndex<T>(this T[] array, in Func<T, double> func)
        {
        ...
        /// </summary>
        [PublicAPI]
        public static int GetTopIndex<T>(List<T> list, in Func<T, double> func)
        {
        ...
        //TODO -Walter- Re-Enable these GetRandom methods.
        /*
        /// <summary>
