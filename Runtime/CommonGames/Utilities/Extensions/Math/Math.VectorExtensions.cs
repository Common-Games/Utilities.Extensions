...
namespace CommonGames.Utilities.Extensions
{
	public static partial class Math
	{
		...
		*/
		...
		[PublicAPI]
		public static Vector3 GetRelativePositionFrom(in this Vector3 position, Matrix4x4 from)
		...
		[PublicAPI]
		public static Vector3 GetRelativeDirectionFrom(in this Vector3 direction, Matrix4x4 from)
		...
		*/
		...
		/*
		[PublicAPI]
		public static Vector2Int RoundedToVector2Int(in this Vector2 v, CGMath.RoundingMode roundingMode) 
			=> new Vector2Int {x = v.x.RoundToInt(), y = v.y.RoundToInt()};
		*/
		
		[PublicAPI]
		public static Vector2Int RoundedToVector2Int(in this Vector2 v) 
			=> new Vector2Int {x = v.x.RoundToInt(), y = v.y.RoundToInt()};
